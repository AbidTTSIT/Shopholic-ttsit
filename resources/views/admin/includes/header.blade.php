 <div class="header">
        <div class="header-left active">
          <a href="{{ route('dashboard') }}" class="logo">
            <img src="https://shopholic.co.in/assets/img/logo-width.png" alt="" />
          </a>
        ...
        <ul class="nav user-menu">
              ...
              <form action="#">
                <div class="searchinputs">
                  ...
                  <div class="search-addon">
                    <span
                      ><img src="{{ asset('assets/admin/img/icons/closes.svg') }}" alt="img"
                    /></span>
                  </div>
                </div>
                <a class="btn" id="searchdiv"
                  ><img src="{{ asset('assets/admin/img/icons/search.svg') }}" alt="img"
                /></a>
              </form>
            </div>
          </li>
          ...
          <li class="nav-item dropdown has-arrow main-drop">
            ...
            >
              <span class="user-img"
                ><img src="{{asset('assets/admin/img/profiles/avator1.jpg')}}" alt="" />
            ...
            <div class="dropdown-menu menu-drop-user">
              <div class="profilename">
                ...
                <a class="dropdown-item logout pb-0" href="{{route('logout')}}"
                  ><img src="{{asset('assets/img/icons/log-out.svg')}}"
                    class="me-2"
                    alt="img"
                  />Logout</a
                >
